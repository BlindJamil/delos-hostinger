...
<body class="bg-delos-cream text-delos-text antialiased">
        ...
        <nav id="navbar" class="transition-all duration-500">
                ...
                <div class="flex items-center justify-between h-18 lg:h-20">
                    ...
                    <div class="hidden lg:block">
                        <a href="{{ route('contact') }}"
                           class="nav-cta inline-flex items-center gap-2 px-5 py-2.5 text-btn border hover:bg-delos-gold hover:text-delos-dark hover:border-delos-gold transition-all duration-300 font-sans">
                            Book Consultation
                        </a>
                    </div>
            ...
            <div id="mobile-menu" class="lg:hidden bg-delos-dark border-t border-white/10">
                <div class="px-6 py-8 flex flex-col gap-6">
                    ...
                    @endforeach
                    <a href="{{ route('contact') }}"
                       class="font-sans mt-4 inline-flex items-center justify-center px-6 py-3 bg-delos-gold text-delos-dark text-[12px] tracking-[0.2em] uppercase font-medium">
                        Book Consultation
                    </a>
                </div>
            </div>
    ...
    <footer class="bg-delos-dark text-delos-cream">
        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-12 pt-20 pb-12">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-8" data-stagger="150">
