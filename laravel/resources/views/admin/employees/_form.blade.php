...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-delos-dark/5 shadow-card p-5" x-data="{
            preview: {{ $employee->image ? json_encode(asset('storage/' . $employee->image)) : 'null' }},
            removing: false,
            onFile(event) {
            ...
            <div x-show="preview" class="mb-3">
                <div class="aspect-square rounded-lg overflow-hidden bg-delos-ivory/60 border border-delos-dark/8">
            ...
            <label x-show="!preview"
                   class="block border-2 border-dashed border-delos-dark/15 hover:border-delos-gold rounded-lg p-6 text-center cursor-pointer transition-colors">
                ...
                <input type="file" name="image" accept="image/jpeg,image/png,image/webp" class="sr-only"
                       @change="onFile" x-ref="file">
            </label>
