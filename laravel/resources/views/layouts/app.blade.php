            ...
            <div class="max-w-[1400px] mx-auto px-6 lg:px-12">
                <div class="flex items-center justify-between h-18 lg:h-20">
                    ...
                    <div class="hidden lg:flex items-center gap-3">
                        ...
                        <a href="{{ $settingYoutube ?: '#' }}" target="_blank" rel="noopener"
                           class="nav-social w-9 h-9 flex items-center justify-center border rounded-full hover:bg-delos-gold hover:border-delos-gold group transition-all duration-300" aria-label="YouTube">
                            <svg class="w-4 h-4 nav-social-icon group-hover:text-delos-dark transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                        </a>
                    </div>
            ...
            <div id="mobile-menu" class="lg:hidden bg-delos-dark border-t border-white/10">
                <div class="px-6 py-8 flex flex-col gap-6">
                    ...
                    <div class="flex items-center gap-3 mt-4 pt-4 border-t border-white/10">
                        ...
                        <a href="{{ $settingYoutube ?: '#' }}" target="_blank" rel="noopener"
                           class="w-10 h-10 flex items-center justify-center border border-delos-gold/30 rounded-full hover:bg-delos-gold group transition-all duration-300" aria-label="YouTube">
                            <svg class="w-4.5 h-4.5 text-delos-gold group-hover:text-delos-dark transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                        </a>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-8" data-motion-group="footer">
                ...
                <div data-motion="fade-up" class="lg:col-span-1">
                    ...
                    <div class="flex items-center gap-4 mt-5">
                        ...
                        <a href="{{ $settingYoutube ?: '#' }}" target="_blank" rel="noopener" class="text-delos-muted hover:text-delos-gold transition-colors duration-300" aria-label="YouTube">
