                    ...
                    <div class="branch-card__info lg:col-span-3 p-8 lg:p-12 flex flex-col justify-center">
                        ...
                        <div class="space-y-4 mb-8">
                            ...
                            @if($branch->phone)
                                <div class="flex items-center gap-3">
                                    ...
                                    {{-- dir="ltr" + unicode-bidi:isolate locks the phone
                                         number's visual order. Without these, an RTL container
                                         like /ar reverses the number's space-separated groups
                                         ("0772 665 6363" displayed as "6363 665 0772") because
                                         each whitespace-separated group is treated as a
                                         separate bidi run. --}}
                                    <a href="tel:{{ preg_replace('/\s+/', '', $branch->phone) }}"
                                       dir="ltr"
                                       style="unicode-bidi: isolate;"
                                       class="text-delos-muted text-sm hover:text-delos-gold transition-colors">{{ $branch->phone }}</a>
                                </div>
                            @endif
                            @if($hours)
                                <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <button
                                ...
                                disabled
                                aria-disabled="true"
                                title="{{ pcontent('branches.vr_coming_soon') }}"
                                aria-label="{{ pcontent('branches.vr_cta') }} — {{ pcontent('branches.vr_coming_soon') }}"
                                class="inline-flex items-center gap-2 px-6 py-3 border border-delos-dark/10 text-delos-dark/40 text-[11px] tracking-[0.25em] uppercase font-medium cursor-not-allowed"
                            >
