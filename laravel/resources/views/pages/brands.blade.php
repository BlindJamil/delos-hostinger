...
{{-- Hero --}}
<section class="relative min-h-[55vh] flex items-end overflow-hidden bg-delos-dark">
    <div class="absolute inset-0">
        <img src="{{ asset('images/brands-hero.jpg') }}" alt=""
             class="w-full h-full object-cover opacity-25" onerror="this.style.display='none'">
...
<section class="py-24 lg:py-32 bg-delos-cream">
    <div class="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div class="grid lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
                <p class="reveal text-delos-gold text-[11px] tracking-[0.4em] uppercase font-medium mb-6" style="font-family: 'Inter', sans-serif;">Exclusive Partnerships</p>
            ...
            <div class="reveal relative aspect-square overflow-hidden bg-delos-dark">
...
<section class="py-24 bg-delos-dark text-center">
    <div class="max-w-[1400px] mx-auto px-6 lg:px-12">
        <h2 class="reveal font-serif text-delos-cream text-4xl lg:text-5xl font-light mb-8">
            Experience Italian luxury<br>
            <em class="text-delos-gold not-italic">in person.</em>
        </h2>
        <a href="{{ route('contact') }}"
           class="reveal inline-flex items-center gap-3 px-10 py-4 bg-delos-gold text-delos-dark text-[12px] tracking-[0.25em] uppercase font-medium hover:bg-delos-gold-light transition-all duration-300">
            Visit a Showroom
        </a>
    </div>
</section>
