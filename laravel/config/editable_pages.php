        ...
        'sections' => [
            ...
            'ctas' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'branches.vr_cta', 'label' => 'Virtual tour button', 'type' => 'text'],
                    ['key' => 'branches.vr_coming_soon', 'label' => '"Coming soon" tag on VR button', 'type' => 'text'],
                    ['key' => 'branches.facebook_label', 'label' => 'Facebook link label', 'type' => 'text'],
                    ['key' => 'branches.instagram_label', 'label' => 'Instagram link label', 'type' => 'text'],
                ],
            ],
        ],
    ],
    ...
    'contact' => [
        ...
        'sections' => [
            ...
            'form' => [
                'label' => 'Contact form',
                'fields' => [
                    ['key' => 'contact.form.method_legend', 'label' => 'Method toggle legend', 'type' => 'text'],
                    ['key' => 'contact.form.method_whatsapp', 'label' => 'Method option — WhatsApp', 'type' => 'text'],
                    ['key' => 'contact.form.method_email', 'label' => 'Method option — Email', 'type' => 'text'],
                    ['key' => 'contact.form.name', 'label' => 'Name label', 'type' => 'text'],
                    ['key' => 'contact.form.name_placeholder', 'label' => 'Name placeholder', 'type' => 'text'],
                    ['key' => 'contact.form.phone', 'label' => 'Phone label (WhatsApp mode)', 'type' => 'text'],
                    ['key' => 'contact.form.phone_placeholder', 'label' => 'Phone placeholder', 'type' => 'text'],
                    ['key' => 'contact.form.email', 'label' => 'Email label (Email mode)', 'type' => 'text'],
                    ...
                    ['key' => 'contact.form.submit_whatsapp', 'label' => 'Submit button — WhatsApp mode', 'type' => 'text'],
                    ...
                    ['key' => 'contact.form.fallback_hint', 'label' => 'Fallback hint (shown if no contact route configured)', 'type' => 'text'],
                ],
            ],
        ],
    ],
        ...
        'sections' => [
            ...
            'form' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'become_dealer.form.fields.business', 'label' => 'Business name · label', 'type' => 'text'],
                    ['key' => 'become_dealer.form.fields.business_placeholder', 'label' => 'Business name · placeholder', 'type' => 'text'],
                    ['key' => 'become_dealer.form.fields.name', 'label' => 'Contact name · label', 'type' => 'text'],
                    ['key' => 'become_dealer.form.fields.name_placeholder', 'label' => 'Contact name · placeholder', 'type' => 'text'],
                    ['key' => 'become_dealer.form.fields.city', 'label' => 'City · label', 'type' => 'text'],
                    ['key' => 'become_dealer.form.fields.city_placeholder', 'label' => 'City · placeholder', 'type' => 'text'],
                    ['key' => 'become_dealer.form.fields.phone', 'label' => 'Phone · label', 'type' => 'text'],
                    ['key' => 'become_dealer.form.fields.phone_placeholder', 'label' => 'Phone · placeholder', 'type' => 'text'],
                    ['key' => 'become_dealer.form.fields.message', 'label' => 'Message · label', 'type' => 'text'],
                    ['key' => 'become_dealer.form.fields.message_placeholder', 'label' => 'Message · placeholder', 'type' => 'text'],
                    ['key' => 'become_dealer.form.submit_whatsapp', 'label' => 'Submit button — WhatsApp mode', 'type' => 'text'],
                    ['key' => 'become_dealer.form.submit_email', 'label' => 'Submit button — Email mode', 'type' => 'text'],
                    ['key' => 'become_dealer.form.fallback_hint', 'label' => 'Fallback hint (shown if no contact route configured)', 'type' => 'text'],
                ],
            ],
            'contact' => [
        ...
        'sections' => [
            ...
            'pages' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'seo.become_dealer.title', 'label' => 'Become a Dealer · title', 'type' => 'text'],
                    ['key' => 'seo.become_dealer.description', 'label' => 'Become a Dealer · description', 'type' => 'textarea'],
                ],
            ],
        ],
    ],
        ...
        'sections' => [
            ...
            'nav' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'common.nav.become_dealer', 'label' => 'Become a Dealer (nav item)', 'type' => 'text'],
                    ['key' => 'common.nav.menu_toggle', 'label' => 'Menu toggle aria label', 'type' => 'text'],
                ],
            ],
            'language_switcher' => [
                'label' => 'Language switcher (screen-reader / tooltip labels)',
                'fields' => [
                    ['key' => 'common.language_switcher.aria_label', 'label' => 'Aria label (screen reader)', 'type' => 'text'],
                    ['key' => 'common.language_switcher.switch_to', 'label' => '"Switch to..." tooltip prefix', 'type' => 'text'],
                ],
            ],
            'marquee' => [
