...
class IraqiArabicContentSeeder extends Seeder
{
    ...
    public const PAGE_CONTENT_UPDATES = [
        ...
        'about.hero.stats.2.label' => ['page'=>'about','section'=>'hero','type'=>'text','value_ar'=>'شركاء إيطاليون'],
        ...
        'seo.about.description' => ['page'=>'seo','section'=>'about','type'=>'textarea',
            'value_ar'=>'تأسّست ديلوس إنترناشيونال بأربيل سنة 2020 حتى تقدّم الفخامة الإيطالية الأصيلة لبيوت العراق. أربع فروع، خمس شركاء إيطاليين، وأكثر من 500 مشروع منجز.'],
        ...
        'seo.brands.title' => ['page'=>'seo','section'=>'brands','type'=>'text',
            'value_ar'=>'الشركاء الإيطاليون — ديلوس إنترناشيونال العراق'],
