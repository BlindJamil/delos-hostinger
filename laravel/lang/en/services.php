...
return [
    ...
    'arch_carousel' => [
        'default_label' => 'LUBE · Luxury Kitchens',
        'slides' => [
    ...
    'info_row' => [
        'blurb' => 'Kitchens, dressing rooms, laundry, furniture, parquet, and more — under one roof.',
        'est' => 'Est. 2020',
    ],

    'intro' => [
        'overline' => 'What We Offer',
        'heading_1' => 'Six Italian crafts.',
        'heading_accent' => 'One standard of luxury.',
    ],
    ...
    'items' => [
        ...
        'dressing_rooms' => [
            ...
            'features' => [
                ...
                'Hinged and sliding door systems',
        ...
        'italian_parquet' => [
            ...
            'features' => [
                'Engineered Italian parquet',
                'Natural hardwood options',
                'Wide-plank and herringbone patterns',
        ...
        'others' => [
            ...
            'features' => [
                ...
                'Personalized 3D design concepts',
                'Italian sourcing and logistics',
    ...
    'item_cta' => 'Book a Consultation',

    'cta' => [
        'overline' => 'Start Today',
        'heading_1' => 'Ready to transform',
        'heading_accent' => 'your space?',
